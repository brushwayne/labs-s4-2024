/* WAP in java which will accept the mark of 3 subject
and print the corresponding grade of for the given mark
using if..else statement in java. use scanner class */
